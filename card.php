...
function display_cards_in_sets() {
    ...
    foreach ($sets as $index => $set) {
 	...
 	echo '<button class="select-pile" data-set="' . $index . '">Select Pile</button>';
...
wp_add_inline_script('ajax-script', $script_data);
...
function card_mini_game_add_admin_menu() {
    add_menu_page('Card Mini Game Settings', 'Card Mini Game', 'manage_options', 'card-mini-game-settings', 'card_mini_game_settings_page');
}
add_action('admin_menu', 'card_mini_game_add_admin_menu');
function card_mini_game_settings_page() {
    ?>
    <div class="wrap">
...
function card_mini_game_register_settings() {
  
    register_setting('card_mini_game_settings', 'openai_api_key');
    register_setting('card_mini_game_settings', 'openai_prompt_template_love','card_mini_game_sanitize_prompt_template');
    register_setting('card_mini_game_settings', 'openai_prompt_template_money','card_mini_game_sanitize_prompt_template');
    register_setting('card_mini_game_settings', 'openai_prompt_template_general','card_mini_game_sanitize_prompt_template');


}
add_action('admin_init', 'card_mini_game_register_settings');
function card_mini_game_sanitize_prompt_template($input) {
    // Sanitize the input as needed
    return sanitize_textarea_field($input);
}

function card_mini_game_sanitize_api_key($input) {
    // Sanitize the input as needed
    return sanitize_text_field($input);
}

register_setting('card_mini_game_settings', 'openai_api_key', 'card_mini_game_sanitize_api_key');
