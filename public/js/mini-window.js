...
.card {
    position: relative;
    width: 550px; /* Adjust based on your card size */
    height: 600px; /* Adjust based on your card size */
}
...
.picked-cards-container img, .picked-cards-container-second-row img {
...
$(document).on('contextmenu', function(e) {
    ...
    // Clear all slots in both containers
    $('#slot-container .card-slot, #slot-container1 .card-slot').html('<button class="remove-card1">Remove</button>');

    // Reset the clickedcards1 and clickedcards2 objects
    clickedcards1 = {};
    clickedcards2 = {};

    // Reset the slot counters
    slotCounter1 = 1;
    slotCounter2 = 4;
});
                </script>
